...
namespace Challenge.Core
{
    public static class Messages
    {
        ...
        public const string SuccessfulWithdrawal = "You have successfully withdrawn ${0:0.00} from account {1}.  Your remaining balance is ${2:0.00}";
        ...
        public const string CustomerNotAccountOwner = "The current customer is not the owner of account {0}";
    }
}
